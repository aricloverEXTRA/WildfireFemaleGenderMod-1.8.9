...
public class UVLayout {
    ...
    public static UVLayout defaultsForLeft() {
        ...
        layout.put(UVDirection.EAST, new UVQuad(24, 22, 27, 27));
        ...
        layout.put(UVDirection.NORTH, new UVQuad(20, 22, 24, 27));
        return layout;
    }

    public static UVLayout defaultsForRight() {
        UVLayout layout = new UVLayout();
        layout.put(UVDirection.EAST, new UVQuad(28, 22, 32, 27));
        ...
        layout.put(UVDirection.NORTH, new UVQuad(24, 22, 28, 27));
        return layout;
    }
