...
public class WildfireBreastCustomizationScreen extends GuiScreen implements GuiSlider.ISlider {
    ...
    private Configuration.PlayerGenderSettings settings;
    ...
    public void initGui() {
        ...
        this.settings = Configuration.getPlayerSettings(this.mc.thePlayer);
        this.isDarkMode = Configuration.getDarkMode(this.mc.thePlayer);
        if (this.settings == null) {
            this.settings = new Configuration.PlayerGenderSettings();
        }
        ...
        this.armorPhysicsButton = new WildfireButton(14, sliderX, armorY, sliderWidth, sliderHeight, String.format(
                ...
                Configuration.getOverrideArmorPhysics(this.mc.thePlayer) ? enabledText : disabledText
        ));
        ...
        this.hideInArmorButton = new WildfireButton(15, sliderX, hideInArmorY, sliderWidth, sliderHeight, String.format(
                ...
                Configuration.getHideInArmor(this.mc.thePlayer) ? enabledText : disabledText
        ));
        this.showArmorTooltipButton = new WildfireButton(16, sliderX, showArmorTooltipY, sliderWidth, sliderHeight, String.format(
                ...
                Configuration.getShowArmorTooltip(this.mc.thePlayer) ? enabledText : disabledText
        ));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        switch (button.id) {
            ...
            case 9:
                ...
                break;
            case 14:
                boolean newArmorPhysics = !Configuration.getOverrideArmorPhysics(this.mc.thePlayer);
                Configuration.setOverrideArmorPhysics(this.mc.thePlayer, newArmorPhysics);
                ...
                break;
            case 15:
                boolean newHide = !Configuration.getHideInArmor(this.mc.thePlayer);
                Configuration.setHideInArmor(this.mc.thePlayer, newHide);
                ...
                break;
            case 16:
                boolean newTooltip = !Configuration.getShowArmorTooltip(this.mc.thePlayer);
                Configuration.setShowArmorTooltip(this.mc.thePlayer, newTooltip);
                ...
                break;
            case 17:
                boolean newHoliday = !Configuration.getHolidayThemes(this.mc.thePlayer);
                Configuration.setHolidayThemes(this.mc.thePlayer, newHoliday);
                ...
                break;
            case 18:
                this.mc.displayGuiScreen(new WildfireBreastUVEditorScreen(this, this.mc.thePlayer != null ? this.mc.thePlayer.getUniqueID() : null));
                break;
            case 11:
                this.selectedTab = 0;
                updateSlidersState();
